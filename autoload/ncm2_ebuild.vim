let g:eclasses_list = [{'word': 'mozcoreconf-v5', 'menu': 'eclass: core options and configuration functions for mozilla'},{'word': 'libtool', 'menu': 'eclass: quickly update bundled libtool code'},{'word': 'qt5-build', 'menu': 'eclass: Eclass for Qt5 split ebuilds'},{'word': 'unpacker', 'menu': 'eclass: helpers for extraneous file formats and consistent behavior across EAPIs'},{'word': 'vcs-clean', 'menu': 'eclass: helper functions to remove VCS directories'},{'word': 'check-reqs', 'menu': 'eclass: Provides a uniform way of handling ebuild which have very high build requirements'},{'word': 'portability', 'menu': 'eclass: This eclass is created to avoid using non-portable GNUisms inside ebuilds'},{'word': 'vcs-snapshot', 'menu': 'eclass: support eclass for unpacking VCS snapshot tarballs'},{'word': 'verify-sig', 'menu': 'eclass: Eclass to verify upstream signatures on distfiles'},{'word': 'distutils-r1', 'menu': 'eclass: A simple eclass to build Python packages using distutils'},{'word': 'toolchain-autoconf', 'menu': 'eclass: Common code for sys-devel/autoconf ebuilds'},{'word': 'golang-build', 'menu': 'eclass: Eclass for compiling go packages'},{'word': 'out-of-source', 'menu': 'eclass: convenient wrapper to build autotools packages out-of-source'},{'word': 'mozcoreconf-v6', 'menu': 'eclass: core options and configuration functions for mozilla'},{'word': 'nvidia-driver', 'menu': 'eclass: Provide useful messages for nvidia-drivers'},{'word': 'ecm', 'menu': 'eclass: Support eclass for packages that use KDE Frameworks with ECM'},{'word': 'preserve-libs', 'menu': 'eclass: preserve libraries after SONAME changes'},{'word': 'virtualx', 'menu': 'eclass: This eclass can be used for packages that needs a working X environment to build'},{'word': 'toolchain-glibc', 'menu': 'eclass: Common code for sys-libs/glibc ebuilds'},{'word': 'latex-package', 'menu': 'eclass: An eclass for easy installation of LaTeX packages'},{'word': 'ltprune', 'menu': 'eclass: Smart'},{'word': 'mono-env', 'menu': 'eclass: Set environment variables commonly used by dotnet packages'},{'word': 'xdg-utils', 'menu': 'eclass: Auxiliary functions commonly used by XDG compliant packages'},{'word': 'bazel', 'menu': 'eclass: Utility functions for packages using Bazel Build'},{'word': 'elisp-common', 'menu': 'eclass: Emacs-related installation utilities'},{'word': 'font', 'menu': 'eclass: Eclass to make font installation uniform'},{'word': 'mate', 'menu': 'eclass: Provides phases for MATE based packages'},{'word': 'kernel-install', 'menu': 'eclass: Installation mechanics for Distribution Kernels'},{'word': 'meson', 'menu': 'eclass: common ebuild functions for meson-based packages'},{'word': 'cmake', 'menu': 'eclass: common ebuild functions for cmake-based packages'},{'word': 'eapi8-dosym', 'menu': 'eclass: Testing implementation of EAPI 8 dosym -r option'},{'word': 'rebar', 'menu': 'eclass: Build Erlang/OTP projects using dev-util/rebar'},{'word': 'mozlinguas-v2', 'menu': 'eclass: Handle language packs for mozilla products'},{'word': 'haskell-cabal', 'menu': 'eclass: for packages that make use of the Haskell Common Architecture for Building Applications and Libraries (cabal)'},{'word': 'python-utils-r1', 'menu': 'eclass: Utility functions for packages with Python parts'},{'word': 'fcaps', 'menu': 'eclass: function to set POSIX file-based capabilities'},{'word': 'java-virtuals-2', 'menu': 'eclass: Java virtuals eclass'},{'word': 'bash-completion-r1', 'menu': 'eclass: A few quick functions to install bash-completion files'},{'word': 'ssl-cert', 'menu': 'eclass: Eclass for SSL certificates'},{'word': 'gnome.org', 'menu': 'eclass: Helper eclass for gnome'},{'word': 'ros-catkin', 'menu': 'eclass: Template eclass for catkin based ROS packages'},{'word': 'lua', 'menu': 'eclass: A common eclass for Lua packages'},{'word': 'optfeature', 'menu': 'eclass: Advertise optional functionality that might be useful to users'},{'word': 'ninja-utils', 'menu': 'eclass: common bits to run dev-util/ninja builder'},{'word': 'docs', 'menu': 'eclass: A simple eclass to build documentation'},{'word': 'python-any-r1', 'menu': 'eclass: An eclass for packages having build-time dependency on Python'},{'word': 'ruby-fakegem', 'menu': 'eclass: An eclass for installing Ruby packages to behave like RubyGems'},{'word': 'estack', 'menu': 'eclass: stack-like value storage support'},{'word': 'eapi7-ver', 'menu': 'eclass: Testing implementation of EAPI 7 version manipulators'},{'word': 'flag-o-matic', 'menu': 'eclass: common functions to manipulate and query toolchain flags'},{'word': 'texlive-module', 'menu': 'eclass: Provide generic install functions so that modular texlive''s texmf ebuild will only have to inherit this eclass'},{'word': 'cmake-utils', 'menu': 'eclass: common ebuild functions for cmake-based packages'},{'word': 'java-pkg-2', 'menu': 'eclass: Eclass for Java Packages'},{'word': 'texlive-common', 'menu': 'eclass: Provide various functions used by both texlive-core and texlive modules'},{'word': 'ruby-ng-gnome2', 'menu': 'eclass: An eclass to simplify handling of various ruby-gnome2 parts'},{'word': 'php-ext-pecl-r3', 'menu': 'eclass: A uniform way to install PECL extensions'},{'word': 'readme.gentoo', 'menu': 'eclass: install a doc file shown via elog messages'},{'word': 'versionator', 'menu': 'eclass: functions which simplify manipulation of ${PV} and similar version strings'},{'word': 'postgres', 'menu': 'eclass: An eclass for PostgreSQL-related packages'},{'word': 'cdrom', 'menu': 'eclass: Functions for CD-ROM handling'},{'word': 'xdg', 'menu': 'eclass: Provides phases for XDG compliant packages'},{'word': 'multilib-build', 'menu': 'eclass: flags and utility functions for building multilib packages'},{'word': 'cvs', 'menu': 'eclass: This eclass provides generic cvs fetching functions'},{'word': 'eutils', 'menu': 'eclass: many extra (but common) functions that are used in ebuilds'},{'word': 'gnome2-utils', 'menu': 'eclass: Auxiliary functions commonly used by Gnome packages'},{'word': 'mount-boot', 'menu': 'eclass: functions for packages that install files into /boot'},{'word': 'mate-desktop.org', 'menu': 'eclass: Helper eclass for mate-desktop'},{'word': 'gnustep-base', 'menu': 'eclass: Internal handling of GNUstep pacakges'},{'word': 'go-module', 'menu': 'eclass: basic eclass for building software written as go modules'},{'word': 'ghc-package', 'menu': 'eclass: This eclass helps with the Glasgow Haskell Compiler''s package configuration utility'},{'word': 'tmpfiles', 'menu': 'eclass: Functions related to tmpfiles'},{'word': 'myspell-r2', 'menu': 'eclass: An eclass to ease the construction of ebuilds for myspell dicts'},{'word': 'git-r3', 'menu': 'eclass: Eclass for fetching and unpacking git repositories'},{'word': 'gstreamer', 'menu': 'eclass: Helps building core & split gstreamer plugins'},{'word': 'cannadic', 'menu': 'eclass: Function for Canna compatible dictionaries'},{'word': 'cmake-multilib', 'menu': 'eclass: cmake-utils wrapper for multilib builds'},{'word': 'python-r1', 'menu': 'eclass: A common, simple eclass for Python packages'},{'word': 'lua-single', 'menu': 'eclass: An eclass for Lua packages not installed for multiple implementations'},{'word': 'acct-user', 'menu': 'eclass: Eclass used to create and maintain a single user entry'},{'word': 'xorg-2', 'menu': 'eclass: Reduces code duplication in the modularized X11 ebuilds'},{'word': 'scons-utils', 'menu': 'eclass: helper functions to deal with SCons buildsystem'},{'word': 'lua-utils', 'menu': 'eclass: Utility functions for packages with Lua parts'},{'word': 'xemacs-packages', 'menu': 'eclass: Eclass to support elisp packages distributed by XEmacs'},{'word': 'oasis', 'menu': 'eclass: Provides common ebuild phases for oasis-based packages'},{'word': 'desktop', 'menu': 'eclass: support for desktop files, menus, and icons'},{'word': 'mono', 'menu': 'eclass: common settings and functions for mono and dotnet related packages'},{'word': 'rust-toolchain', 'menu': 'eclass: helps map gentoo arches to rust ABIs'},{'word': 'emboss-r2', 'menu': 'eclass: Use this to easy install EMBOSS and EMBASSY programs (EMBOSS add-ons)'},{'word': 'vala', 'menu': 'eclass: Sets up the environment for using a specific version of vala'},{'word': 'golang-vcs', 'menu': 'eclass: Eclass for fetching and unpacking go repositories'},{'word': 'golang-base', 'menu': 'eclass: Eclass that provides base functions for Go packages'},{'word': 'kodi-addon', 'menu': 'eclass: Helper for correct building and (importantly) installing Kodi addon packages'},{'word': 'gnome2', 'menu': 'eclass: Provides phases for Gnome/Gtk+ based packages'},{'word': 'fixheadtails', 'menu': 'eclass: functions to replace obsolete head/tail with POSIX compliant ones'},{'word': 'gnustep-2', 'menu': 'eclass: eclass for GNUstep Apps, Frameworks, and Bundles build'},{'word': 'opam', 'menu': 'eclass: Provides functions for installing opam packages'},{'word': 'php-pear-r2', 'menu': 'eclass: Provides means for an easy installation of PEAR packages'},{'word': 'linux-info', 'menu': 'eclass: eclass used for accessing kernel related information'},{'word': 'multibuild', 'menu': 'eclass: A generic eclass for building multiple variants of packages'},{'word': 'kernel-build', 'menu': 'eclass: Build mechanics for Distribution Kernels'},{'word': 'llvm.org', 'menu': 'eclass: Common bits for fetching & unpacking llvm'},{'word': 'waf-utils', 'menu': 'eclass: common ebuild functions for waf-based packages'},{'word': 'java-utils-2', 'menu': 'eclass: Base eclass for Java packages'},{'word': 'dune', 'menu': 'eclass: Provides functions for installing dune packages'},{'word': 'fortran-2', 'menu': 'eclass: Simplify fortran compiler management'},{'word': 'python-single-r1', 'menu': 'eclass: An eclass for Python packages not installed for multiple implementations'},{'word': 'savedconfig', 'menu': 'eclass: common API for saving/restoring complex configuration files'},{'word': 'mozextension', 'menu': 'eclass: Install extensions for use in mozilla products'},{'word': 'sgml-catalog-r1', 'menu': 'eclass: Functions for installing SGML catalogs'},{'word': 'golang-vcs-snapshot', 'menu': 'eclass: support eclass for unpacking VCS snapshot tarballs for'},{'word': 'mercurial', 'menu': 'eclass: This eclass provides generic mercurial fetching functions'},{'word': 'java-pkg-opt-2', 'menu': 'eclass: Eclass for package with optional Java support'},{'word': 'multilib', 'menu': 'eclass: This eclass is for all functions pertaining to handling multilib configurations'},{'word': 'games', 'menu': 'eclass: Standardizing the install of games'},{'word': 'sword-module', 'menu': 'eclass: Simplify installation of SWORD modules'},{'word': 'pax-utils', 'menu': 'eclass: functions to provide PaX markings for hardened kernels'},{'word': 'postgres-multi', 'menu': 'eclass: An eclass to build PostgreSQL-related packages against multiple slots'},{'word': 'vim-plugin', 'menu': 'eclass: used for installing vim plugins'},{'word': 'freedict', 'menu': 'eclass: Ease the installation of freedict translation dictionaries'},{'word': 'multiprocessing', 'menu': 'eclass: multiprocessing helper functions'},{'word': 'chromium-2', 'menu': 'eclass: Shared functions for chromium and google-chrome'},{'word': 'ruby-utils', 'menu': 'eclass: An eclass for supporting ruby scripts and bindings in non-ruby packages'},{'word': 'elisp', 'menu': 'eclass: Eclass for Emacs Lisp packages'},{'word': 'linux-mod', 'menu': 'eclass: It provides the functionality required to install external modules against a kernel source tree'},{'word': 'perl-functions', 'menu': 'eclass: helper functions eclass for perl modules'},{'word': 'edos2unix', 'menu': 'eclass: convert files from DOS CRLF to UNIX LF line endings'},{'word': 'udev', 'menu': 'eclass: Default eclass for determining udev directories'},{'word': 'db', 'menu': 'eclass: Internal eclass used by sys-libs/db ebuilds'},{'word': 'netsurf', 'menu': 'eclass: Handle buildsystem of'},{'word': 'epatch', 'menu': 'eclass: easy patch application functions'},{'word': 'cuda', 'menu': 'eclass: Common functions for cuda packages'},{'word': 'java-osgi', 'menu': 'eclass: Java OSGi eclass'},{'word': 'llvm', 'menu': 'eclass: Utility functions to build against slotted LLVM'},{'word': 'base', 'menu': 'eclass: The base eclass defines some default functions and variables'},{'word': 'kernel-2', 'menu': 'eclass: Eclass for kernel packages'},{'word': 'qmail', 'menu': 'eclass: common qmail functions'},{'word': 's6', 'menu': 'eclass: helper functions to install s6 services'},{'word': 'acct-group', 'menu': 'eclass: Eclass used to create and maintain a single group entry'},{'word': 'rpm', 'menu': 'eclass: convenience class for extracting RPMs'},{'word': 'ada', 'menu': 'eclass: An eclass for Ada packages'},{'word': 'openib', 'menu': 'eclass: Simplify working with OFED packages'},{'word': 'wrapper', 'menu': 'eclass: create a shell wrapper script'},{'word': 'qmake-utils', 'menu': 'eclass: Common functions for qmake-based packages'},{'word': 'apache-module', 'menu': 'eclass: Provides a common set of functions for apache modules'},{'word': 'libretro-core', 'menu': 'eclass: Simplify libretro core ebuilds'},{'word': 'gkrellm-plugin', 'menu': 'eclass: Provides src_install used by (almost) all gkrellm plugins'},{'word': 'l10n', 'menu': 'eclass: convenience functions to handle localizations'},{'word': 'selinux-policy-2', 'menu': 'eclass: This eclass supports the deployment of the various SELinux modules in sec-policy'},{'word': 'office-ext-r1', 'menu': 'eclass: Eclass for installing libreoffice/openoffice extensions'},{'word': 'systemd', 'menu': 'eclass: helper functions to install systemd units'},{'word': 'prefix', 'menu': 'eclass: Eclass to provide Prefix functionality'},{'word': 'cargo', 'menu': 'eclass: common functions and variables for cargo builds'},{'word': 'toolchain-funcs', 'menu': 'eclass: functions to query common info about the toolchain'},{'word': 'apache-2', 'menu': 'eclass: Provides a common set of functions for apache-2'},{'word': 'ruby-single', 'menu': 'eclass: An eclass for Ruby packages not installed for multiple implementations'},{'word': 'dotnet', 'menu': 'eclass: common settings and functions for mono and dotnet related packages'},{'word': 'common-lisp-3', 'menu': 'eclass: functions to support the installation of Common Lisp libraries'},{'word': 'cron', 'menu': 'eclass: Some functions for cron'},{'word': 'pam', 'menu': 'eclass: Handles pam related tasks'},{'word': 'php-ext-source-r3', 'menu': 'eclass: Compile and install standalone PHP extensions'},{'word': 'user', 'menu': 'eclass: user management in ebuilds'},{'word': 'darcs', 'menu': 'eclass: This eclass provides functions for fetch and unpack darcs repositories'},{'word': 'user-info', 'menu': 'eclass: Read-only access to user and group information'},{'word': 'readme.gentoo-r1', 'menu': 'eclass: install a doc file shown via elog messages'},{'word': 'subversion', 'menu': 'eclass: Fetch software sources from subversion repositories'},{'word': 'vim-spell', 'menu': 'eclass: Eclass for managing Vim spell files'},{'word': 'kde.org', 'menu': 'eclass: Support eclass for packages that are hosted on kde'},{'word': 'autotools', 'menu': 'eclass: Regenerates auto* build scripts'},{'word': 'ruby-ng', 'menu': 'eclass: An eclass for installing Ruby packages with proper support for multiple Ruby slots'},{'word': 'webapp', 'menu': 'eclass: functions for installing applications to run under a web server'},{'word': 'xorg-3', 'menu': 'eclass: Reduces code duplication in the modularized X11 ebuilds'},{'word': 'java-pkg-simple', 'menu': 'eclass: Eclass for packaging Java software with ease'},{'word': 'perl-module', 'menu': 'eclass: eclass for installing Perl module distributions'},{'word': 'ant-tasks', 'menu': 'eclass: Eclass for building dev-java/ant-* packages'},{'word': 'wxwidgets', 'menu': 'eclass: Manages build configuration for wxGTK-using packages'},{'word': 'java-vm-2', 'menu': 'eclass: Java Virtual Machine eclass'},{'word': 'findlib', 'menu': 'eclass: ocamlfind (a'},{'word': 'nsplugins', 'menu': 'eclass: reusable functions for netscape/moz plugin sharing'},{'word': 'alternatives', 'menu': 'eclass: Creates symlink to the latest version of multiple slotted packages'},{'word': 'usr-ldscript', 'menu': 'eclass: Defines the gen_usr_ldscript function'},{'word': 'depend.apache', 'menu': 'eclass: Functions to allow ebuilds to depend on apache'},{'word': 'java-ant-2', 'menu': 'eclass: eclass for ant based Java packages'},{'word': 'aspell-dict-r1', 'menu': 'eclass: An eclass to streamline the construction of ebuilds for new aspell dicts'},{'word': 'multilib-minimal', 'menu': 'eclass: wrapper for multilib builds providing convenient multilib_src_* functions'},{'word': 'vdr-plugin-2', 'menu': 'eclass: common vdr plugin ebuild functions'},{'word': 'autotools-utils', 'menu': 'eclass: common ebuild functions for autotools-based packages'},{'word': 'autotools-multilib', 'menu': 'eclass: autotools-utils wrapper for multilib builds'},]
