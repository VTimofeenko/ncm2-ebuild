...
func! ncm2_ebuild#init() abort
	call ncm2#register_source(g:ncm2_ebuild#main_source)
endfunc
...
let g:ncm2_ebuild#main_source= extend(
			\ get(g:, 'ncm2_ebuild#main_source', {}), {
			\ 'name': 'ebuild',
			\ 'scope': ['ebuild'],
			\ 'priority': 0,
			\ 'mark': 'ebm',
			\ 'on_complete': 'ncm2_ebuild#on_complete_main',
			\ 'complete_length': 1,
			\ }, 'keep')
			"\ 'word_pattern': ':[\w+-]*:?',

func! ncm2_ebuild#on_complete_main(ctx) abort
	let matches = [
